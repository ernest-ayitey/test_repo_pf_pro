 ...
 *
 * @fmt: format of op
 * @fm_t: function associaated with it 
 */
...
/**function for printing char and strings**/
...
int print_octal (va_list types, char buffer[],
		int flags, int width, int precision, int size);
int print_hexadecinal(va_list types, char buffer[],
		int flags, int width, int preccision, int size);
int print_hexa_upper(va_list types, char buffer[],
		int flags, int width, char precision, int size);
...
long int  convert_size_unsgnd(unsigned int num, int size);
